...
def add_leader():
    ...
    if data['status'] == 'user':
        ...
        leader_entry = {'timestamp': timestamp, 'score': data['score'], 'lifespan': data['lifespan'], 'name': player, 'status': data['status']}
        ...
        leader_entry = {'timestamp': timestamp, 'score': data['score'], 'lifespan': data['lifespan'], 'name': data['name'], 'status': data['status']}
    with open(os.path.dirname(__file__) + '/leaders.json') as leaders_file:
        content = json.load(leaders_file)
        content.append(leader_entry)
