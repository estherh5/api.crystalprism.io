...
def create_user():
    ...
    data = {'username': username, 'password': hashed_password, 'salt': salt.decode(), 'first_name': '', 'last_name': '', 'name_public': '', 'email': '', 'email_public': '', 'background_color': '#ffffff', 'color': '#000000', 'about': '', 'admin': False, 'member_since': member_since, 'shapes_plays': 0, 'shapes_scores': [], 'shapes_high_score': 0, 'rhythm_plays': 0, 'rhythm_scores': [], 'rhythm_high_score': 0, 'rhythm_high_lifespan': '00:00:00', 'drawings': [], 'liked_drawings': [], 'post_number': 0}
            ...
            for info in content:
                if info['username'].lower() == user_id.lower():
                    ...
                    if info['email_public'] == True:
                        ...
                        email = ''
                    data = {'name': name, 'email': email, 'background_color': info['background_color'], 'color': info['color'], 'about': info['about'], 'member_since': info['member_since'], 'shapes_high_score': info['shapes_high_score'], 'rhythm_high_lifespan': info['rhythm_high_lifespan'], 'drawings': info['drawings']}
                    return jsonify(data)
